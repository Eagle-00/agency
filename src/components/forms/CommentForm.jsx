...
export const CommentForm = ({ postId }) => {
  ...
  const [comment, setComment] = useState({
    name: '', email: '', website: '', content: '', post: ''
  });
  ...
  const handleSubmit = async ( event ) => {
    ...
    try {
      ...
      if (violations) {
        ...
        setErrors(apiErrors);
        toast.warn("Erreur lors de l'envoi du message, veuillez réessayer plus tard");
      }
    }
  };
  // Functions
...
CommentForm.propTypes = { postId: PropTypes.any.isRequired };
